...
It calculates and shows with graphs different metrics, such as actual effort, cost, progress or deviation from the goals of the projects.
...
3. Install the plugin running the commands below from your Redmine directory
   ...
   need to append RAILS_ENV=production to each line):
     ...
     rake cmi:create_goal_indicators
