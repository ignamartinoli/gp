...
# Gems de los plugins añadidas automáticamente
gem "redmine_crm"  # from plugins-test/redmine_agile/Gemfile
gem 'slim-rails'  # from plugins-test/additionals/Gemfile
gem "imgkit"  # from plugins-test/dpi_cmi-master/Gemfile
