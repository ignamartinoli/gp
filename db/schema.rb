...
ActiveRecord::Schema.define(version: 2018_09_23_091603) do
  ...
  create_table "auth_sources", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
  ...
  create_table "boards", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
  ...
  create_table "bookmarks", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.bigint "convocatorias_id"
    t.integer "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["convocatorias_id"], name: "index_bookmarks_on_convocatorias_id"
  end

  create_table "campos", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.bigint "componente_id"
    t.bigint "tipo_campo_id"
    t.string "pregunta"
    t.text "descripcion"
    t.integer "obligatorio", default: 1, null: false
    t.integer "activo", default: 1
    t.datetime "created_at", default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.datetime "updated_at", default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.boolean "tiene_pregunta_orientadora", default: false
    t.integer "permite_adjuntos", default: 0, null: false
    t.integer "subcampo", default: 0
    t.integer "autoevaluacion", default: 0
    t.bigint "subcampo_de"
    t.index ["componente_id"], name: "campos_ibfk_1"
    t.index ["subcampo_de"], name: "fk_subcampo_de"
    t.index ["tipo_campo_id"], name: "tipo_campo_id"
  end

  create_table "changes", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
  ...
  create_table "changeset_parents", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "changeset_id", null: false
  ...
  create_table "changesets", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
  ...
  create_table "changesets_issues", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "changeset_id", null: false
  ...
  create_table "componentes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["dimension_id"], name: "index_componentes_on_dimension_id"
  end

  create_table "convocatorias", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "resolucion"
    t.string "nombre"
    t.date "fecha_inicio"
    t.date "fecha_hasta"
  ...
  create_table "convocatorias_componentes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.bigint "convocatoria_id", null: false
    t.bigint "componente_id", null: false
    t.index ["componente_id"], name: "fk_rails_abeae68185"
    t.index ["convocatoria_id", "componente_id"], name: "index_convocatoria_componentes"
  end

  create_table "convocatorias_especialidades", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.bigint "convocatoria_id", null: false
    t.bigint "especialidad_id", null: false
    t.index ["convocatoria_id", "especialidad_id"], name: "index_convocatoria_especialidades"
    t.index ["especialidad_id"], name: "fk_rails_b3efabb802"
  end

  create_table "convocatorias_sedes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.bigint "convocatoria_id", null: false
    t.bigint "sede_id", null: false
    t.index ["convocatoria_id", "sede_id"], name: "index_convocatoria_sedes"
    t.index ["sede_id"], name: "fk_rails_d1b4961880"
  end
  ...
  create_table "custom_fields", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "type", limit: 30, default: "", null: false
  ...
  create_table "custom_fields_projects", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
  ...
  create_table "custom_fields_roles", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "custom_field_id", null: false
    t.integer "role_id", null: false
    t.index ["custom_field_id", "role_id"], name: "custom_fields_roles_ids", unique: true
  end

  create_table "custom_fields_trackers", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "custom_field_id", default: 0, null: false
  ...
  create_table "custom_values", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
  ...
  create_table "dimensiones", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "dimension"
    t.integer "activo", default: 1
  end
  ...
  create_table "especialidades", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "nombre"
    t.integer "codigo"
  ...
  create_table "especialidades_sedes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.bigint "especialidad_id", null: false
    t.bigint "sede_id", null: false
    t.integer "activo", default: 1
    t.index ["especialidad_id", "sede_id"], name: "index_especialidades_sedes"
    t.index ["sede_id"], name: "fk_rails_6a232f93d2"
  end
  ...
  create_table "historic_values", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "issue_id"
    t.integer "valor"
    t.date "fecha"
    t.index ["issue_id"], name: "index_historic_values_on_issue_id"
  end
  ...
  create_table "issue_categories", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "project_id", default: 0, null: false
    t.string "name", limit: 60, default: "", null: false
  ...
  create_table "issue_relations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
  ...
  create_table "issue_statuses", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "name", limit: 30, default: "", null: false
  ...
  create_table "issues", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    ...
    t.boolean "valor_automatico", default: false, null: false
  ...
  create_table "journal_details", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
  ...
  create_table "journals", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
  ...
  create_table "member_roles", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
  ...
  create_table "meta", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "descripcion"
    t.integer "peso", default: 0
    t.integer "avance", default: 0
    t.bigint "issue_id"
    t.index ["issue_id"], name: "index_meta_on_issue_id"
  end
  ...
  create_table "opciones_campos", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.bigint "campo_id", null: false
    t.string "opcion", null: false
    t.integer "valor", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["campo_id"], name: "index_opciones_campos_on_campo_id"
  end

  create_table "open_id_authentication_associations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "issued"
    t.integer "lifetime"
    t.string "handle"
    t.string "assoc_type"
  ...
  create_table "open_id_authentication_nonces", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "timestamp", null: false
    t.string "server_url"
    t.string "salt", null: false
  end

  create_table "periodos", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "issue_id"
    t.integer "periodo"
    t.integer "ind_min"
    t.integer "ind_med"
    t.integer "ind_max"
    t.index ["issue_id"], name: "index_periodos_on_issue_id"
  end
  ...
  create_table "projects", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    ...
    t.boolean "cmi_validar_fecha_inicio_indicadores", default: false
    t.boolean "cmi_reports", default: false
  ...
  create_table "projects_trackers", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "project_id", default: 0, null: false
    t.integer "tracker_id", default: 0, null: false
  ...
  create_table "queries", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "project_id"
    t.string "name", default: "", null: false
    t.text "filters"
    t.integer "user_id", default: 0, null: false
  ...
  create_table "queries_roles", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "query_id", null: false
    t.integer "role_id", null: false
    t.index ["query_id", "role_id"], name: "queries_roles_ids", unique: true
  end

  create_table "regionales", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "nombre"
    t.integer "codigo"
    t.integer "tipo"
    t.integer "activo", default: 1
  ...
  create_table "reminder_configurations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "days"
  ...
  create_table "reminder_issue_statuses", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "reminder_configuration_id"
    t.integer "issue_status_id"
  end

  create_table "reminder_projects", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "reminder_configuration_id"
    t.integer "project_id"
  end

  create_table "reminder_trackers", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "reminder_configuration_id"
    t.integer "tracker_id"
  end

  create_table "repositories", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "project_id", default: 0, null: false
  ...
  create_table "respuestas_formulario", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.bigint "campo_id", null: false
    t.bigint "usuario_id"
    t.text "respuesta_texto"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["campo_id"], name: "index_respuestas_formulario_on_campo_id"
    t.index ["usuario_id"], name: "index_respuestas_formulario_on_usuario_id"
  end

  create_table "respuestas_opciones", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.bigint "respuestas_formulario_id", null: false
    t.bigint "opciones_campos_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["opciones_campos_id"], name: "index_respuestas_opciones_on_opciones_campos_id"
    t.index ["respuestas_formulario_id"], name: "index_respuestas_opciones_on_respuestas_formulario_id"
  end
  ...
  create_table "sedes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "nombre"
    t.integer "regional"
    t.integer "codigo"
    t.integer "activo", default: 1
  ...
  create_table "time_entries", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "project_id", null: false
    t.integer "user_id", null: false
    t.integer "issue_id"
  ...
  create_table "tipos_campo", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "nombre"
    t.text "descripcion"
    t.integer "activo", default: 1
    t.datetime "created_at", default: -> { "CURRENT_TIMESTAMP" }, null: false
  ...
  create_table "tokens", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "user_id", default: 0, null: false
  ...
  create_table "trackers", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "name", limit: 30, default: "", null: false
  ...
  create_table "user_preferences", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "user_id", default: 0, null: false
    t.text "others"
  ...
  create_table "watchers", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
  ...
  create_table "wiki_content_versions", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
  ...
  create_table "wiki_contents", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "page_id", null: false
    t.integer "author_id"
  ...
  create_table "wiki_pages", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
  ...
  create_table "wiki_redirects", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "wiki_id", null: false
    t.string "title"
  ...
  create_table "wikis", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "project_id", null: false
  ...
  create_table "workflows", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "tracker_id", default: 0, null: false
  ...
  add_foreign_key "bookmarks", "convocatorias", column: "convocatorias_id"
  add_foreign_key "campos", "campos", column: "subcampo_de", name: "fk_subcampo_de", on_delete: :nullify
  add_foreign_key "campos", "componentes", name: "campos_ibfk_1"
  add_foreign_key "campos", "tipos_campo", column: "tipo_campo_id", name: "campos_ibfk_2"
  add_foreign_key "componentes", "dimensiones", column: "dimension_id"
  add_foreign_key "convocatorias_componentes", "componentes"
  add_foreign_key "convocatorias_componentes", "convocatorias"
  add_foreign_key "convocatorias_especialidades", "convocatorias"
  add_foreign_key "convocatorias_especialidades", "especialidades", column: "especialidad_id"
  add_foreign_key "convocatorias_sedes", "convocatorias"
  add_foreign_key "convocatorias_sedes", "sedes"
  add_foreign_key "especialidades_sedes", "especialidades", column: "especialidad_id"
  add_foreign_key "especialidades_sedes", "sedes"
  add_foreign_key "opciones_campos", "campos"
  add_foreign_key "respuestas_formulario", "campos"
  add_foreign_key "respuestas_opciones", "opciones_campos", column: "opciones_campos_id"
  add_foreign_key "respuestas_opciones", "respuestas_formulario"
end
