...
ActiveSupport::Reloader.to_prepare do
  ...
  unless ApplicationHelper.included_modules.include?(LocalAvatarsPlugin::ApplicationAvatarPatch)
    # ProjectsHelper.send(:include, DpiCmiProjectsHelperPatch)
    ApplicationHelper.send(:prepend, LocalAvatarsPlugin::ApplicationAvatarPatch)
  end
  ...
  unless UsersHelper.included_modules.include?(LocalAvatarsPlugin::UsersHelperPatch)
    # ProjectsHelper.send(:include, DpiCmiProjectsHelperPatch)
    UsersHelper.send(:prepend, LocalAvatarsPlugin::UsersHelperPatch)
  end
end
